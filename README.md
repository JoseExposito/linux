...
| [patch-hp-envy-x360-ignore-battery]([https://github.com/JoseExposito/linux/tree/patch-hp-envy-x360-ignore-battery](https://github.com/JoseExposito/linux/tree/patch-uclogic-force-hidinput)) | [upstream-hid-master](https://github.com/JoseExposito/linux/tree/upstream-hid-master) | UCLogic: Force input quirk for digitizers | ⏳ |
...
| [patch-xppen-reconnection](https://github.com/JoseExposito/linux/tree/patch-xppen-reconnection) | [upstream-hid-for-next](https://github.com/JoseExposito/linux/tree/upstream-hid-for-next) | Handle XP-PEN reconnection when using the USB dongle | 🔨 |
